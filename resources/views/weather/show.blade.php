                ...
                <form method="GET" action="{{ route('weather.show') }}" class="mt-6">
                    <div class="flex rounded-md shadow-sm">
                        <input 
                            type="text" 
                            name="city" 
                            class="flex-1 min-w-0 block w-full px-3 py-3 rounded-l-md border-gray-300 focus:ring-blue-500 focus:border-blue-500 text-gray-700 border" 
                            placeholder="Enter city name" 
                            value="{{ $city }}"
                        >
                        <button 
                            type="submit" 
                            class="inline-flex items-center px-4 py-3 border border-transparent text-sm font-medium rounded-r-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                        >
                            Search
                        </button>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <div class="text-right">
                                <p class="text-blue-200 capitalize">{{ $weather['weather'][0]['description'] }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between mb-8">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <span class="block text-blue-200">Feels like {{ round($weather['main']['feels_like']) }}°C</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 text-center">
                            ...
                            <div class="bg-blue-400 bg-opacity-30 rounded-lg p-3">
                                ...
                                <p class="text-sm text-blue-100">Pressure</p>
                            ...
                            <div class="bg-blue-400 bg-opacity-30 rounded-lg p-3">
                                ...
                                <p class="text-sm text-blue-100">Visibility</p>
